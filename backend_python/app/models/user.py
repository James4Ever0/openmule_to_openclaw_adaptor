...
class User(BaseModel):
    ...
    refund_requests = relationship("RefundRequest", foreign_keys="RefundRequest.client_id", back_populates="client")
    refund_requests_as_ai = relationship("RefundRequest", foreign_keys="RefundRequest.ai_id")
    disputes = relationship("Dispute", foreign_keys="Dispute.client_id", back_populates="client")
